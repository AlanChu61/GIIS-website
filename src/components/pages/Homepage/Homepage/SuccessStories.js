...
const STUDENTS = [
  {
    ...
    courses: ['Sports Psychology', 'Sports Management & Leadership', 'Biology Advanced', 'Physics – Mechanics', 'Athletic Training', 'Fitness Leadership'],
    quote: {
  ...
  },
  {
    ...
    courses: ['Digital Literacy', 'Communication Studies', 'Media & Society', 'Statistics for Social Sciences', 'Research Methods in Social Science', 'Academic Writing'],
    quote: {
